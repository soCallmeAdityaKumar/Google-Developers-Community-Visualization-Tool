...
class TourGDGThread internal constructor(
    private val infoScrapingList: List<InfoScraping>,
    ...
    override fun run() {
        ...
        while (running.get()) {
            ...
            sendInformationLG(infoScrapingList[i] as GDG, actionController)
            try {
    ...
    private fun sendInformationLG(gdg: GDG, actionController: ActionController?) {
        val poiLocation = POILocation(gdg.name!!, gdg.longitude, gdg.latitude, 3000.0)
